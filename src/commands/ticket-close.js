...
module.exports = {
	...
	async execute(interaction) {
        ...
        const command = `dotnet /bot/DiscordChatExporter/DiscordChatExporter.Cli.dll export -t ${token} -c ${interaction.channel.id} -o ../ticket-logs/${interaction.channel.name}.html`;
        exec(command,
